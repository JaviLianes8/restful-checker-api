...
def analyze():
    ...
    try:
        ...
        # Don't delete the HTML file right away; it has been returned in the response
        # Clean up HTML file after it is served (if needed)
        # os.unlink(html_path)
